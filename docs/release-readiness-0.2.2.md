# État de préparation à la publication 0.2.2

> [!NOTE]
> Ce document fige les preuves de préparation de la version `0.2.2`. La
> fondation de rapport CODE Framework ajoutée après cette version est consignée
> dans la section `Non publié` du changelog. Elle ne fait pas encore l’objet
> d’un numéro de version, d’un package candidat, d’un tag ou d’une release
> GitHub.
